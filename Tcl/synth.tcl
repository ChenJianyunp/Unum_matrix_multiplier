...
proc synth { module } {
   ...
   puts "$resultDir/${moduleName}_synth_design.rds"
   set start_time [clock seconds]
   if {$topLevel} {
   ...
   set end_time [clock seconds]
   log_time synth_design $start_time $end_time 0 $options
   ...
   if {$verbose >= 1} {
      ...
      set end_time [clock seconds]
      log_time report_utilization $start_time $end_time 0 "Write out synthesis DCP"
   }
